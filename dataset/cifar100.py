...
import numpy as np
import random
def load_cifar100(train_size=400,train_pho=0.1,val_size=100,val_pho=1,image_size=224,batch_size=128,num_workers=4,path='./data',num_classes=100):
    ...
    num_train_samples=[]
    num_val_samples=[]
    train_mu=train_pho**(1./(num_classes-1.))
    val_mu=val_pho**(1./(num_classes-1.))
    ...
    return train_loader,val_loader,test_loader,eval_train_loader,eval_val_loader
